...
import {AnalogData, DigitalData, TagsList} from "../models/DTOs.ts";
import AlarmList from "../components/AlarmList.tsx";
import signalRTagService from "../services/signalRTagService";
...
export default function TagsCRUD() {
    ...
    const [tags, setTags] = useState<TagsList>({analogInputs: [], digitalInputs: []});
